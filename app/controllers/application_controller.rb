class ApplicationController < ActionController::Base
  ...
  def slack_integration_html
    ...
    @slack_integration_html = link.html_safe
  end
  ...
  def authenticate_manager!
    redirect_to root_path and return unless user_signed_in? && current_user.manager?
  end

  def authenticate!
    redirect_to root_path and return unless user_signed_in? || freelancer_signed_in?
  end
