...
class Message < ApplicationRecord
  ...
  def process_command
    if self.body =~ /\/charge \$?([\d\.]+)/
      ...
      unless self.msg_type == 'bot-half-charge-task'
        self.update(body: "Can you please pay <strong>$#{amount}</strong> to continue on this deliverable?", msg_type: 'bot-charge-task')
      end
